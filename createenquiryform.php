          ...
          <div class="nav-tabs-custom">
            ...
            <div class="">
              <div class="tab-pane active" id="Post_Activities">
                ...
                <label>
				  <input type="radio"  name="candidate_type" id="" value="Company"> <label style="padding:0 18px" value="Company">  Company </label>
            ...
            <div class="form-group" >
			  <div class=""> <label for="exampleInputEmail1">Search Enquiry No:</label></div>
                 <div class="">
				  <input type="text" name="search_enquiryid" id="search_enquiryid" class="form-control" id="" placeholder="Search" onkeyup="getNo(this.value)"> <i class="fa fa-search" style="position: absolute;    margin-left: 290px;    margin-top: -24px;"></i></div>
				  </div>
				  </div>
...
$('#datepicker1').datepicker({
 ...
 //alert(rate);
  if (str1.length == 0) { 
    document.getElementById("enquiryiddiv").innerHTML = "";
    return;
  }
 ...
 xhttp1 = new XMLHttpRequest();
  ...
  xhttp1.open("GET", "getautogenerateno.php?q1="+str1, true);
  xhttp1.send(); 
